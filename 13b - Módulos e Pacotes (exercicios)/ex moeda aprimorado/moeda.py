...
def aumentar(valor = 0, porcent = 0, formatar = False):
    aumentado = valor * (1 + porcent/100)  # aumenta em X% (definido no main.py) o valor inicial
...
def diminuir(valor = 0, porcent = 0, formatar = False):
    diminuido = valor * (1 - porcent/100)  # diminui em X% (definido no main.py) o valor inicial
